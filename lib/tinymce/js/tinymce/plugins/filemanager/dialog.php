	    ...
	    Dropzone.options.myAwesomeDropzone = {
		    ...
		    accept: function(file, done) {
			    ...
			    if ($.inArray(extension, allowed_ext) > -1) {
				    ...
				    // var img='<p><img src="/public/attachment/'+name+'"></img></p>';
...
<div class="uploader">
	...
	<div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
	    ...
	    <ul class="nav nav-tabs">
			...
			<li style="display:none"><a href="#tab2" id="uploader-btn" data-toggle="tab"><?php echo lang_Upload_java; ?></a></li>
	    </ul>
		...
		<div class="filters">
			...
			<div class="span4 half"> 
			    ...
			    <?php if($create_text_files){ ?>
						    <button style="" class="tip btn create-file-btn" title="<?php echo  lang_New_File; ?>"><i class="icon-plus"></i><i class="icon-file"></i></button> 
			    <?php } ?>
			    <?php if($create_folders){ ?>
						    <button style="" class="tip btn new-folder" title="<?php echo  lang_New_Folder?>"><i class="icon-plus"></i><i class="icon-folder-open"></i></button> 
			    <?php } ?>
			    <?php if($copy_cut_files || $copy_cut_dirs){ ?>
				    <button style="" class="tip btn paste-here-btn" title="<?php echo lang_Paste_Here; ?>"><i class="rficon-clipboard-apply"></i></button> 
				    <button style="" class="tip btn clear-clipboard-btn" title="<?php echo lang_Clear_Clipboard; ?>"><i class="rficon-clipboard-clear"></i></button> 
				<?php } ?>
			</div>
